...
#SBATCH --job-name=TFM_PrelimFeat
...
echo "============================================================"
echo "TFM preliminary experiment using cached features"
...
echo
echo "Starting feature-space preliminary experiment..."
echo
...
echo
echo "============================================================"
echo "Feature-space preliminary experiment finished"
echo "End time: $(date)"
